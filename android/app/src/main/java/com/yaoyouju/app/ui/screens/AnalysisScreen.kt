...
// ---------- 文案构建（与 App 端 utils/chief.ts 同逻辑） ----------

private data class ChangeAnswers(
...
private fun parseChangeText(raw: String?): ChangeAnswers {
...
private fun buildSelfDescription(change: ChangeAnswers): String {
