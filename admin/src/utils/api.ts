...
export const api = {
  ...
  getSafetyEvents: () => request('/admin/safety-events'),
  getCaseSubmissions: () => request('/admin/case-submissions'),
  getSafetyRuleVersion: () => request('/safety/rules/version'),
  ...
  rollbackModel: (data: any) => request('/models/rollback', { method: 'POST', body: JSON.stringify(data) }),
